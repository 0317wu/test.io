...
from linebot.models import (
    ...
    ButtonsTemplate,
    URIAction,
    LocationAction  # 確保引入 LocationAction
)
...
def show_main_menu(event):
    flex_message = FlexSendMessage(
        ...
        contents={
            ...
            "hero": {
                "type": "image",
                "url": "https://images.unsplash.com/photo-1554284126-aa88f22d8d2d?fit=crop&w=800&q=80",  # 健身相關圖片
                "size": "full",
                "aspectRatio": "20:13",
                "aspectMode": "cover",
                "action": {"type": "uri", "uri": "https://yourwebsite.com"}  # 可選擇性保留或修改
            },
            "body": {
                "type": "box",
                "layout": "vertical",
            ...
            "footer": {
                ...
                "contents": [
                    ...
                    },
                    {
                        "type": "button",
                        "style": "primary",
                        "action": {"type": "location", "label": "📍 找附近的健身房"}  # 修改為 LocationAction
                    }
                ]
            }
        }
...
def show_fat_loss_plan(event):
    flex_message = FlexSendMessage(
        ...
        contents={
            ...
            "hero": {
                "type": "image",
                "url": "https://images.unsplash.com/photo-1571019613578-2b3d0d9d9d3a?fit=crop&w=800&q=80",  # 有氧運動圖片
                "size": "full",
                "aspectRatio": "20:13",
                "aspectMode": "cover"
            },
...
def show_muscle_gain_plan(event):
    flex_message = FlexSendMessage(
        ...
        contents={
            ...
            "hero": {
                "type": "image",
                "url": "https://images.unsplash.com/photo-1526406915897-5d6aef2d43ed?fit=crop&w=800&q=80",  # 重訓圖片
                "size": "full",
                "aspectRatio": "20:13",
                "aspectMode": "cover"
            },
...
def show_cardiovascular_plan(event):
    flex_message = FlexSendMessage(
        ...
        contents={
            ...
            "hero": {
                "type": "image",
                "url": "https://images.unsplash.com/photo-1554284126-aa88f22d8d2d?fit=crop&w=800&q=80",  # 游泳或跑步圖片
                "size": "full",
                "aspectRatio": "20:13",
                "aspectMode": "cover"
            },
...
def show_beginner_diet_plan(event):
    flex_message = FlexSendMessage(
        ...
        contents={
            ...
            "hero": {
                "type": "image",
                "url": "https://images.unsplash.com/photo-1587502536263-9a174a4a98a7?fit=crop&w=800&q=80",  # 高蛋白食物圖片
                "size": "full",
                "aspectRatio": "20:13",
                "aspectMode": "cover"
            },
...
def show_intermediate_diet_plan(event):
    flex_message = FlexSendMessage(
        ...
        contents={
            ...
            "hero": {
                "type": "image",
                "url": "https://images.unsplash.com/photo-1606761566270-0979e3519a36?fit=crop&w=800&q=80",  # 複合碳水化合物圖片
                "size": "full",
                "aspectRatio": "20:13",
                "aspectMode": "cover"
            },
...
def show_advanced_diet_plan(event):
    flex_message = FlexSendMessage(
        ...
        contents={
            ...
            "hero": {
                "type": "image",
                "url": "https://images.unsplash.com/photo-1606755967743-8c02be96e861?fit=crop&w=800&q=80",  # 飲食時機安排圖片
                "size": "full",
                "aspectRatio": "20:13",
                "aspectMode": "cover"
            },
...
def show_beginner_training_plan(event):
    flex_message = FlexSendMessage(
        ...
        contents={
            ...
            "hero": {
                "type": "image",
                "url": "https://images.unsplash.com/photo-1605296867304-46d5465a13f1?fit=crop&w=800&q=80",  # 初學者訓練計劃圖片
                "size": "full",
                "aspectRatio": "20:13",
                "aspectMode": "cover",
...
def show_intermediate_training_plan(event):
    flex_message = FlexSendMessage(
        ...
        contents={
            ...
            "hero": {
                "type": "image",
                "url": "https://images.unsplash.com/photo-1554284126-aa88f22d8d2d?fit=crop&w=800&q=80",  # 中級者訓練計劃圖片
                "size": "full",
                "aspectRatio": "20:13",
                "aspectMode": "cover",
...
def show_advanced_training_plan(event):
    flex_message = FlexSendMessage(
        ...
        contents={
            ...
            "hero": {
                "type": "image",
                "url": "https://images.unsplash.com/photo-1571019613578-2b3d0d9d9d3a?fit=crop&w=800&q=80",  # 高級者訓練計劃圖片
                "size": "full",
                "aspectRatio": "20:13",
                "aspectMode": "cover",
    ...
    if exercise in video_urls:
        ...
        flex_message = FlexSendMessage(
            ...
            contents={
                ...
                "hero": {
                    "type": "image",
                    "url": "https://images.unsplash.com/photo-1605296867304-46d5465a13f1?fit=crop&w=800&q=80",  # 運動教學影片縮圖圖片
                    "size": "full",
                    "aspectRatio": "16:9",
                    "aspectMode": "cover",
...
# 查詢最近的健身房已經修改為正確處理 LocationMessage
...
def handle_message(event):
    ...
    if user_id in user_states:
        ...
        elif state.get('state') == 'viewing_body_records':
            if user_message.startswith("體態紀錄上一頁"):
                handle_body_record_pagination(event, "上一頁")
                return
            elif user_message.startswith("體態紀錄下一頁"):
                handle_body_record_pagination(event, "下一頁")
                return
